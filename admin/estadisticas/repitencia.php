                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="matriculados" class="form-control" placeholder="Cantidad de alumnos" readonly>
                                        </div>
                                    </div>
                                    <!-- Repetidores -->
                                    <div class="col-md-3">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("agregarDatos").addEventListener("click", function () {
        ...
        datos.push({ ciclo, turno, grado, matriculados, repetidores, porcentajeRepetencia });
